...
export default class SelectItemsPrompt extends Dialog {
  constructor(items, dialogData={}, options={}) {
    ...
    this.options.classes = ["eh5e", "dialog", "select-items-prompt", "sheet"];
  ...
  static async create(items, {hint}) {
    ...
    const html = await renderTemplate("systems/eh5e/templates/apps/select-items-prompt.html", {items, hint});
    return new Promise(resolve => {
      const dlg = new this(items, {
        title: game.i18n.localize("EH5E.SelectItemsPromptTitle"),
        content: html,
        buttons: {
          apply: {
            icon: '<i class="fas fa-user-plus"></i>',
            label: game.i18n.localize("EH5E.Apply"),
            callback: html => {
          ...
          cancel: {
            ...
            label: game.i18n.localize("EH5E.Skip"),
            callback: () => resolve([])
          }
        },
        default: "apply",

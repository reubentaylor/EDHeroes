...
export default class ActiveEffect5e extends ActiveEffect {
  ...
  apply(actor, change) {
    ...
    if ( change.key.startsWith("flags.eh5e.") ) change = this._prepareFlagChange(actor, change);
  ...
  _prepareFlagChange(actor, change) {
    ...
    const data = CONFIG.EH5E.characterFlags[key.replace("flags.eh5e.", "")];
    ...
    switch ( a.dataset.action ) {
      case "create":
        return owner.createEmbeddedDocuments("ActiveEffect", [{
          label: game.i18n.localize("EH5E.EffectNew"),
  ...
  static prepareActiveEffectCategories(effects) {
    ...
    const categories = {
      temporary: {
        type: "temporary",
        label: game.i18n.localize("EH5E.EffectTemporary"),
        effects: []
      },
      passive: {
        type: "passive",
        label: game.i18n.localize("EH5E.EffectPassive"),
        effects: []
      },
      inactive: {
        type: "inactive",
        label: game.i18n.localize("EH5E.EffectInactive"),
        effects: []
      },
      suppressed: {
        type: "suppressed",
        label: game.i18n.localize("EH5E.EffectUnavailable"),
        effects: [],
        info: [game.i18n.localize("EH5E.EffectUnavailableInfo")]
      }
    };

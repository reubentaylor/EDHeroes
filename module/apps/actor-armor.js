...
export default class ActorArmorConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      classes: ["eh5e", "actor-armor-config"],
      template: "systems/eh5e/templates/apps/actor-armor.html",
      width: 320,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("EH5E.ArmorConfig")}: ${this.document.name}`;
  }
  ...
  async getData() {
    ...
    return {
      ac: ac,
      calculations: CONFIG.EH5E.armorClasses,
  ...
  async _onChangeInput(event) {
    ...
    const cfg = CONFIG.EH5E.armorClasses[calc];

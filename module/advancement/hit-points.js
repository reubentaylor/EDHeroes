...
export class HitPointsAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      order: 10,
      icon: "systems/eh5e/icons/svg/hit-points.svg",
      title: game.i18n.localize("EH5E.AdvancementHitPointsTitle"),
      hint: game.i18n.localize("EH5E.AdvancementHitPointsHint"),
      multiLevel: true,
  ...
  /** @inheritdoc */
  get levels() {
    return Array.fromRange(CONFIG.EH5E.maxLevel + 1).slice(1);
  }
...
export class HitPointsConfig extends AdvancementConfig {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/eh5e/templates/advancement/hit-points-config.html"
    });
  }
...
export class HitPointsFlow extends AdvancementFlow {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/eh5e/templates/advancement/hit-points-flow.html"
    });
  }
  ...
  _updateObject(event, formData) {
    ...
    throw new AdvancementError(game.i18n.localize(`EH5E.AdvancementHitPoints${errorType}Error`));
  }

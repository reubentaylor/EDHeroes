...
export default class ActorMovementConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["eh5e"],
      template: "systems/eh5e/templates/apps/movement-config.html",
      width: 300,
      height: "auto"
    });
  }
  ...
  /** @override */
  get title() {
    return `${game.i18n.localize("EH5E.MovementConfig")}: ${this.document.name}`;
  }
  ...
  getData(options) {
    ...
    const data = {
      ...
      units: CONFIG.EH5E.movementUnits
    };

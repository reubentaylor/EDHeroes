...
export class AdvancementConfirmationDialog extends Dialog {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/eh5e/templates/advancement/advancement-confirmation-dialog.html",
      jQuery: false
    });
  }
  ...
  static forDelete(item) {
    return this.createDialog(
      item,
      game.i18n.localize("EH5E.AdvancementDeleteConfirmationTitle"),
      game.i18n.localize("EH5E.AdvancementDeleteConfirmationMessage"),
      {
  ...
  static forLevelDown(item) {
    return this.createDialog(
      item,
      game.i18n.localize("EH5E.AdvancementLevelDownConfirmationTitle"),
      game.i18n.localize("EH5E.AdvancementLevelDownConfirmationMessage"),
      {
        icon: '<i class="fas fa-sort-numeric-down-alt"></i>',
        label: game.i18n.localize("EH5E.LevelActionDecrease")
      }
    );
  }

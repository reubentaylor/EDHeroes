...
export default class PropertyAttribution extends Application {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      classes: ["eh5e", "property-attribution"],
      template: "systems/eh5e/templates/apps/property-attribution.html",
      width: 320,
      height: "auto"
    });
  }
  ...
  getPropertyLabel(property) {
    ...
    if ( parts[0] === "abilities" && parts[1] ) {
      return CONFIG.EH5E.abilities[parts[1]] ?? property;
    } else if ( (property === "attributes.ac.dex") && CONFIG.EH5E.abilities.dex ) {
      return CONFIG.EH5E.abilities.dex;
    } else if ( (parts[0] === "prof") || (property === "attributes.prof") ) {
      return game.i18n.localize("EH5E.Proficiency");
    }
    return property;
  }
}

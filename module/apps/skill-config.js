...
export default class ActorSkillConfig extends DocumentSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["eh5e"],
      template: "systems/eh5e/templates/apps/skill-config.html",
      width: 500,
      height: "auto"
    });
  }
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.format("EH5E.SkillConfigureTitle", {skill: CONFIG.EH5E.skills[this._skillId]})}: ${this.document.name}`;
  }
  ...
  getData(options) {
    return {
      ...
      proficiencyLevels: CONFIG.EH5E.proficiencyLevels,
  ...
  _updateObject(event, formData) {
    ...
    if ( !passiveRoll.isDeterministic ) {
      const message = game.i18n.format("EH5E.FormulaCannotContainDiceError", {
        name: game.i18n.localize("EH5E.SkillBonusPassive")
      });
